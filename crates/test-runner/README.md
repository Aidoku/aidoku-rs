...
A tool for running tests on Buny sources via a custom source runner.

This features a (nearly) complete Buny source runner backed by [wasmer](https://wasmer.io/), barring the following features:
